                  ...
                  children: [
                    GestureDetector(
                      onTap: () => Get.toNamed(AppRoute.residenceDetailsScreen,
                          arguments: controller.allResidencesDataList[index].id
                        ...
                        children: [
                          Row(
                            children: [
                              IconButton(
                                onPressed: () async {
                                  await controller.residenceToggleLike(index);
                                },
                                icon: Icon(
                                  controller.isResidenceLiked(index)
                                      ? Icons.thumb_up_alt_rounded
                                      : Icons.thumb_up_off_alt_outlined,
                                  color: controller.isResidenceLiked(index) ? Colors.black : null,
                                ),
                              ),
                              Text("${controller.getResidenceLikeCount(index)}")
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              IconButton(
                                  onPressed: () {
                                    Get.to(CommentScreen(id: controller.allResidencesDataList[index].id.toString()));
                                  },
                                  icon: const FaIcon(FontAwesomeIcons.commentDots)),

                              Text(controller.allResidencesDataList[index].comments.toString()),
                          ...
                          Row(
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  try {
                                    final id = controller.allResidencesDataList[index].id.toString();
