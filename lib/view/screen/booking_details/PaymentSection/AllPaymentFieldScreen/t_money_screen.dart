...
import 'Controller/t_money_controller.dart';

class TMoneyPaymentScreen extends StatefulWidget {
  const TMoneyPaymentScreen(
      {super.key,
      required this.token,
  ...
  @override
  State<TMoneyPaymentScreen> createState() => _TMoneyPaymentScreenState();
}

class _TMoneyPaymentScreenState extends State<TMoneyPaymentScreen> {
  final _cardController = Get.put(TMoneyPaymentController());
